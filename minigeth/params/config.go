...
// IsMerge returns whether num is either equal to the Merge (EIP-3675) fork block or greater.
// This does NOT indicate whether we've already switched to proof-of-stake!
// TODO: remove
