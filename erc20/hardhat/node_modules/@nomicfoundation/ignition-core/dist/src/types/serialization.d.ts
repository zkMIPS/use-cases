 ...
 * @beta
 */
export type SerializedBaseArgumentType = number | SerializedBigInt | string | boolean | FutureToken | SerializedRuntimeValue;
/**
 * The serialized version of ArgumentType
 *
 * @beta
 */
export type SerializedArgumentType = SerializedBaseArgumentType | SerializedArgumentType[] | {
 ...
 * @beta
 */
export type SerializedRuntimeValue = SerializedAccountRuntimeValue | SerializedModuleParameterRuntimeValue;
/**
