 ...
 */
export declare enum ExecutionSateType {
 ...
 */
interface BaseExecutionState<ExecutionStateT extends ExecutionSateType, FutureTypeT extends FutureType> {
    id: string;
 ...
 */
export interface DeploymentExecutionState extends BaseExecutionState<ExecutionSateType.DEPLOYMENT_EXECUTION_STATE, DeploymentExecutionStateFutureTypes> {
    artifactId: string;
    contractName: string;
 ...
 */
export interface CallExecutionState extends BaseExecutionState<ExecutionSateType.CALL_EXECUTION_STATE, FutureType.CONTRACT_CALL> {
    artifactId: string;
 ...
 */
export interface StaticCallExecutionState extends BaseExecutionState<ExecutionSateType.STATIC_CALL_EXECUTION_STATE, FutureType.STATIC_CALL> {
    artifactId: string;
    contractAddress: string;
    functionName: string;
    args: SolidityParameterType[];
 ...
 */
export interface EncodeFunctionCallExecutionState extends BaseExecutionState<ExecutionSateType.ENCODE_FUNCTION_CALL_EXECUTION_STATE, FutureType.ENCODE_FUNCTION_CALL> {
    artifactId: string;
    functionName: string;
    args: SolidityParameterType[];
    result: string;
 ...
 */
export interface SendDataExecutionState extends BaseExecutionState<ExecutionSateType.SEND_DATA_EXECUTION_STATE, FutureType.SEND_DATA> {
    to: string;
    data: string;
    value: bigint;
    from: string;
 ...
 * Their execution is immediately completed.
 */
export interface ContractAtExecutionState extends BaseExecutionState<ExecutionSateType.CONTRACT_AT_EXECUTION_STATE, FutureType.NAMED_ARTIFACT_CONTRACT_AT | FutureType.CONTRACT_AT> {
    artifactId: string;
    contractName: string;
    contractAddress: string;
}
 ...
 */
export interface ReadEventArgumentExecutionState extends BaseExecutionState<ExecutionSateType.READ_EVENT_ARGUMENT_EXECUTION_STATE, FutureType.READ_EVENT_ARGUMENT> {
    artifactId: string;
    eventName: string;
    nameOrIndex: string | number;
    txToReadFrom: string;
