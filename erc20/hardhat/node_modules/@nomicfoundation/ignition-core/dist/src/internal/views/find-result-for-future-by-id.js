...
function findResultForFutureById(deploymentState, futureId) {
    ...
    (0, assertions_1.assertIgnitionInvariant)(exState.type === execution_state_1.ExecutionSateType.DEPLOYMENT_EXECUTION_STATE ||
        ...
        exState.type === execution_state_1.ExecutionSateType.ENCODE_FUNCTION_CALL_EXECUTION_STATE, `Expected execution state for ${futureId} to be support result lookup, but instead it was ${exState.type}`);
    ...
    if (exState.type === execution_state_1.ExecutionSateType.READ_EVENT_ARGUMENT_EXECUTION_STATE ||
        exState.type === execution_state_1.ExecutionSateType.ENCODE_FUNCTION_CALL_EXECUTION_STATE) {
